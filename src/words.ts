...
const progWeb: Translation[] = [
  ...
  { "word": "Спасылка", "translation": "ссылка", "options": ["кодировка", "исходник", "страница"] },
    ...
    { "word": "інтэграванае асяроддзе распрацоўкі", "translation": "интегрированная среда разработки", "options": ["кодировщик", "компилятор", "блокнот"] },
    { "word": "cістэма кіравання версіями", "translation": "система управления версиями", "options": ["система мониторинга", "хранилище данных", "система обновления версий"] },
    { "word": "ліставанне", "translation": "переписка", "options": ["публикация", "веб-конференция", "озеленение"] }
]
